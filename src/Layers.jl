# Dense Layer
function dense(w::Variable, x::BroadcastedOperator, b::Variable, activation, result_preallocation::Constant, preallocation_A::Constant, preallocation_x::Constant)
    ...
    return activation(mul(w, x, result_preallocation, preallocation_A, preallocation_x) .+ b) 
end
